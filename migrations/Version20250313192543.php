 ...
 */
final class Version20250313192543 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE actor (actor_id SERIAL NOT NULL, first_name VARCHAR(45) NOT NULL, last_name VARCHAR(45) NOT NULL, last_update TIMESTAMP(0) WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(actor_id))');
        ...
        $this->addSql('CREATE TABLE address (address_id SERIAL NOT NULL, city_id INT NOT NULL, address VARCHAR(50) NOT NULL, address2 VARCHAR(50) DEFAULT NULL, district VARCHAR(20) NOT NULL, postal_code VARCHAR(10) DEFAULT NULL, phone VARCHAR(20) NOT NULL, last_update TIMESTAMP(0) WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(address_id))');
        ...
        $this->addSql('CREATE TABLE category (category_id SERIAL NOT NULL, name VARCHAR(25) NOT NULL, last_update TIMESTAMP(0) WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(category_id))');
        $this->addSql('COMMENT ON COLUMN category.last_update IS \'(DC2Type:datetimetz_immutable)\'');
        $this->addSql('CREATE TABLE city (city_id SERIAL NOT NULL, country_id INT NOT NULL, city VARCHAR(50) NOT NULL, last_update TIMESTAMP(0) WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(city_id))');
        ...
        $this->addSql('CREATE TABLE country (country_id SERIAL NOT NULL, country VARCHAR(50) NOT NULL, last_update TIMESTAMP(0) WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(country_id))');
        $this->addSql('COMMENT ON COLUMN country.last_update IS \'(DC2Type:datetimetz_immutable)\'');
        $this->addSql('CREATE TABLE customer (customer_id SERIAL NOT NULL, address_id INT NOT NULL, store_id INT NOT NULL, first_name VARCHAR(45) NOT NULL, last_name VARCHAR(45) NOT NULL, email VARCHAR(50) NOT NULL, activebool BOOLEAN DEFAULT true NOT NULL, active SMALLINT DEFAULT NULL, create_date TIMESTAMP(0) WITH TIME ZONE NOT NULL, last_update TIMESTAMP(0) WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(customer_id))');
        ...
        $this->addSql('CREATE TABLE film (film_id SERIAL NOT NULL, language_id INT NOT NULL, original_language_id INT DEFAULT NULL, title VARCHAR(128) NOT NULL, description TEXT DEFAULT NULL, release_year year NOT NULL, rental_duration SMALLINT DEFAULT 3 NOT NULL, rental_rate NUMERIC(4, 2) DEFAULT \'4.99\' NOT NULL, length SMALLINT DEFAULT NULL, replacement_cost NUMERIC(5, 2) DEFAULT \'19.99\' NOT NULL, rating mpaa_rating DEFAULT \'G\' NOT NULL, special_features text[] NOT NULL, fulltext tsvector NOT NULL, last_update TIMESTAMP(0) WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(film_id))');
        ...
        $this->addSql('CREATE TABLE film_actor (film_id INT NOT NULL, actor_id INT NOT NULL, last_update TIMESTAMP(0) WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(film_id, actor_id))');
        ...
        $this->addSql('CREATE TABLE film_category (film_id INT NOT NULL, category_id INT NOT NULL, last_update TIMESTAMP(0) WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(film_id, category_id))');
        ...
        $this->addSql('CREATE TABLE inventory (inventory_id SERIAL NOT NULL, film_id INT NOT NULL, store_id INT NOT NULL, last_update TIMESTAMP(0) WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(inventory_id))');
        ...
        $this->addSql('CREATE UNIQUE INDEX idx_unq_rental_rental_date_inventory_id_customer_id ON rental (rental_date, inventory_id, customer_id)');
        ...
        $this->addSql('CREATE TABLE store (store_id SERIAL NOT NULL, manager_staff_id INT DEFAULT NULL, address_id INT NOT NULL, last_update TIMESTAMP(0) WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(store_id))');
