 ...
 */
final class Version20250311204145 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE city (city_id SERIAL NOT NULL, country_id INT NOT NULL, city VARCHAR(50) NOT NULL, last_update TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(city_id))');
        ...
        $this->addSql('CREATE TABLE inventory (inventory_id SERIAL NOT NULL, film_id INT NOT NULL, store_id INT NOT NULL, last_update TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(inventory_id))');
        ...
        $this->addSql('CREATE TABLE rental (rental_id SERIAL NOT NULL, inventory_id INT NOT NULL, customer_id INT NOT NULL, staff_id INT NOT NULL, rental_date TIMESTAMP(0) WITH TIME ZONE NOT NULL, return_date TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, last_update TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(rental_id))');
        ...
        $this->addSql('CREATE TABLE store (store_id SERIAL NOT NULL, manager_staff_id INT DEFAULT NULL, address_id INT NOT NULL, last_update TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(store_id))');
